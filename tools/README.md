...
`TST011` <!-- Pending: two instances from one image share no state --> in the requirements tree.
Each needs a machine-readable *is it serving yet* rather than a scraped log line.
