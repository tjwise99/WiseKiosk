...
- **TODO(#18):** declare one tag per `SRS` id a container satisfies (e.g. `tag SRS018`) and
  apply it (`#SRS018`) to that container, replacing `#needs-srs`. The element→source `link`s that
