...
beside them ([ADR 0019 rev 7](../decisions/0019-boundary-at-what-deploys-and-tag-tier.md)). A
...
**A relationship is declared once, at its true endpoints** ([ADR 0019 rev 7](../decisions/0019-boundary-at-what-deploys-and-tag-tier.md)).
...
module that reads it has a need** ([ADR 0019 rev 7](../decisions/0019-boundary-at-what-deploys-and-tag-tier.md)).

**A component earns a place by its interface — what it exposes, and who calls it — and each container
holds only its framework half** ([ADR 0019 rev 7](../decisions/0019-boundary-at-what-deploys-and-tag-tier.md)).
...
[ADR 0021 rev 4](../decisions/0021-repository-layout.md) fixes hold source, a `link` property
...
([ADR 0019 rev 7](../decisions/0019-boundary-at-what-deploys-and-tag-tier.md)). At the Context level
...
([ADR 0019 rev 7](../decisions/0019-boundary-at-what-deploys-and-tag-tier.md)). There is no exemption
