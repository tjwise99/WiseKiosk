...
Doorstop itself renders no browsable view any more — the click-through traceability view of this
tree (needtables, link graphs, matrices) is now built by the documentation site silo,
[`../site/README.md`](../site/README.md) (ADR 0004); this directory stays the requirements' canonical
source and gate, not its presentation.
