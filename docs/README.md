...
| [`contracts/display-styling-contract.md`](contracts/display-styling-contract.md) | The display styling contract an author follows by hand: the region frame's usage, the grouping vocabulary, the type and spacing scales, the typeface, and how shared tokens are delivered | The configuration schema's region roster ([ADR 0025 rev 1](decisions/0025-display-region-roster.md)); a testable "shall" obligation (the requirements tree) |
