...
| [`architecture/`](architecture/README.md) | The LikeC4 source model the `ARCHITECTURE.md` diagrams are generated from, and the layout of its dev-only silo | The as-built prose description of the system (`ARCHITECTURE.md`); why LikeC4 rather than another notation (an ADR) |
