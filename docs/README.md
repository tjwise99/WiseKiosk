...
| [`architecture/`](architecture/README.md) | The LikeC4 source model the `ARCHITECTURE.md` diagrams are generated from | The as-built prose description of the system (`ARCHITECTURE.md`); why LikeC4 rather than another notation (an ADR); how the model's tooling is laid out, which belongs beside it |
