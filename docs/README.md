...
| [`../CLAUDE.md`](../CLAUDE.md) | Working rules layered on top for an AI agent — review independence, halt-and-ask, and the mechanism that delivers `../CONTRIBUTING.md` into a session | Any fact about WiseKiosk (every document above); a testable obligation (the requirements tree) |
