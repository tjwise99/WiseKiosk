...
regions of the page. See the [README](../README.md) for the product definition, and SYS002, SYS004
and SYS005 with their SRS children in the [requirements tree](requirements/README.md) for the
intended architecture until this section describes the built one. The frontend's static-bundle shape
is not a need: it is a repository check, in [`CI.md`](CI.md).
...
[ADR 0007](decisions/0007-config-validation-allocation.md)'s. Normative shape: SRS001, SRS006,
SRS008, SRS009, SRS011, SRS012, SRS013, SRS016, SRS019, SRS028.
...
[the module contract](contracts/module-contract.md). Normative shape: SRS002, SRS003, SRS005,
SRS010, SRS016, SRS017, SRS021, SRS024, SRS026, SRS027; configuration validation is frontend-owned per
...
whole system (SYS005, SRS015–SRS016, [ADR 0001](decisions/0001-backend-language-go.md)). The codegen
...
to the page; the configuration is a static file bind-mounted into the served tree (SRS018), validated
by the frontend at apply time (SRS002) and by the standalone desk validator
([`../tools/README.md`](../tools/README.md)) through one implementation (SRS005). A secret reaches the backend only as the file named by `<NAME>_FILE` — never
through configuration, and never through a bare `<NAME>` environment variable (SRS007).

## Deployment

_To be documented as it is built._ Container image, bind-mounted config, `_FILE` secrets. Normative
shape: SRS018, SRS025, SRS022, SRS020. The health signal and the restart policy are properties of
...
properties the product owes (SRS018, SRS025, SRS020) under SYS003 and SYS006, and the served
response's browser hardening (SRS010, SRS027, SRS028) under SYS004 and SYS006, each with TST
