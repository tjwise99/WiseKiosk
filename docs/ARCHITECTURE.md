...
SYS005 and SYS025 with their SRS children in the [requirements tree](requirements/README.md) for the
...
[the module contract](contracts/module-contract.md). Normative shape: SRS002, SRS002,
SRS007–SRS008, SRS024–SRS032, SRS028; configuration validation is frontend-owned per
...
whole system (SYS006, SRS023–SRS032, [ADR 0001](decisions/0001-backend-language-go.md)). The codegen
