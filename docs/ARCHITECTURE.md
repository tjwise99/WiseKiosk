...
whole system (SYS023, SRS029–SRS032, [ADR 0001](decisions/0001-backend-language-go.md)). The codegen
...
[requirements tree](requirements/README.md): SYS026 (hardened, reproducible image), SYS027
(first-party code gated before merge), SYS028 (dependency risk gated and tracked), SYS029
(published-artifact supply-chain integrity) and SYS030 (runtime browser-security headers), each with
