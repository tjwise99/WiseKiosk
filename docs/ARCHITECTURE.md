...
[ADR 0020 rev 4](decisions/0020-release-artifact-set-and-operator-tooling.md)'s, and the wiring around
...
package that compiles it ([ADR 0021 rev 4](decisions/0021-repository-layout.md)). What the drift
