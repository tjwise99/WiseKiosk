...
regions of the page. See the [README](../README.md) for the product definition, and SYS002, SYS005
and SYS006 with their SRS children in the [requirements tree](requirements/README.md) for the
...
whole system (SYS006, SRS023–SRS024, [ADR 0001](decisions/0001-backend-language-go.md)). The codegen
...
to the page; the configuration is a static file bind-mounted into the served tree (SRS011), validated
