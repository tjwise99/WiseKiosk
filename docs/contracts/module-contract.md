...
([ADR 0019 rev 8](../decisions/0019-boundary-at-what-deploys-and-tag-tier.md)). The `TST` stubs are
...
([ADR 0019 rev 8](../decisions/0019-boundary-at-what-deploys-and-tag-tier.md) § Where a tag sits),
...
refusing to say which — the aggregate placeholder ADR 0019 rev 8 refuses. The specification says
