...
at length about *which hand-rolled form* a check should take — [ADR 0005 rev 3](0005-traceability-gating.md) on
...
[ADR 0004 rev 3](0004-docs-site-sphinx-needs.md). `check-arch` validates the model with `likec4 validate`,
