...
| [0025](0025-display-region-roster.md) | 2 | 2026-08-18 | Display region roster: a fixed named set of eleven regions the frame lays out beside one another, not an operator-configurable grid |
