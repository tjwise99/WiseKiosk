...
| [0007](0007-config-validation-allocation.md) | 2026-07-23 | Config validation: one standalone Go library; backend as boot gate and reporter; frontend renders the validation report |
