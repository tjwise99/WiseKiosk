...
| [0014](0014-documentation-index-claims-documents.md) | 3 | 2026-08-02 | A tracked document is claimed by a row in the documentation index, machinery under a top-level dot-directory aside; both sides of that are derived from `git ls-files`, never from a hand-maintained inventory or an exclusions list |
