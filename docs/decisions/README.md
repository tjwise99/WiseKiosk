...
| [0005](0005-traceability-gating.md) | 2 | 2026-08-23 | All work traces to the requirements tree via in-repo gates; forward evidence and drift are Doorstop's own `references` + `keyword` and its sha hook, one authored gate proves no test is unclaimed, derived verification status, tree as backlog |
