...
| [0015](0015-container-toolchain-and-image-annotations.md) | 2026-08-02 | Image built with Docker Buildx; nine OCI keys carried as config labels and manifest annotations, none hardcoded in the Dockerfile, `.created` being the commit timestamp |
