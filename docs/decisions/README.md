...
| [0002](0002-requirements-management-doorstop.md) | 3 | 2026-07-21 | Requirements tracked and V&V-gated with Doorstop (SYS→SRS→TST tree) |
...
| [0008](0008-boundary-contract-openapi-codegen.md) | 4 | 2026-08-31 | Boundary contract: one OpenAPI schema (3.0.3 now, 3.1 later), the whole wire contract — routes, client, server and types — generated from it on both sides, CI drift-gated and compiled |
...
| [0021](0021-repository-layout.md) | 2 | 2026-08-30 | The top level projects the containers: a Go module root, an npm package root, the boundary schema owned by neither, and the release material outside both; a module's files split across the packages that run them, under one name |
