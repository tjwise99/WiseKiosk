...
| [0026](0026-boundary-error-body-shape.md) | 3 | 2026-08-19 | Boundary error bodies are two compact custom components of required strings, `cause` left open; not RFC 7807 and not a closed enum; a request whose context ended mid-flight answers 503 under the cause `shutting-down`, in the module-carrying body |
