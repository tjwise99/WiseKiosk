...
| [0015](0015-container-toolchain-and-image-annotations.md) | 2026-08-02 | Image built with Docker Buildx; nine OCI annotations generated from the build context, `.created` being the commit timestamp; checked on both the image config and the manifest |
