...
| [0024](0024-secret-file-delivery.md) | 1 | 2026-07-24 | Every secret delivered as the file named by `<NAME>_FILE` and by no other path — value trailing-whitespace-stripped, read per resolution not cached, a bare `<NAME>` env var ignored; the mechanism is specified in this ADR, not in the tree |
