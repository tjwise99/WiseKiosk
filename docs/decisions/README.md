...
| [0021](0021-component-earns-its-interface-and-framework-half-only.md) | 2026-08-05 | A component is a responsibility with a nameable interface, so the route registry is not one; the framework/module seam is the module contract's, and only the framework half is drawn until module needs exist |
