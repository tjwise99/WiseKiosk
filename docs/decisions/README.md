...
| [0017](0017-authored-language-set.md) | 6 | 2026-08-16 | Authored language follows the artifact's audience: Go, TypeScript and CSS for what ships, Python (standard library only) for what checks the repository; sh and JavaScript author nothing, and a toolchain's own configuration format is invoking rather than authoring |
