...
| [0016](0016-maintained-tools-for-standard-artifacts.md) | 2026-08-03 | A check is authored only where what it reads is this repository's own invention; zizmor, actionlint, lychee, commitlint and pre-commit replace four authored checks and three conventions that did not survive the trade |
