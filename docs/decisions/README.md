...
| [0008](0008-boundary-contract-openapi-codegen.md) | 4 | 2026-08-23 | Boundary contract: one OpenAPI schema (3.0.3 now, 3.1 later), the whole wire contract — routes, client, server and types — generated from it on both sides, CI drift-gated and compiled |
