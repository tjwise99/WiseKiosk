...
which is what [ADR 0017 rev 9](0017-authored-language-set.md) admits for what ships: the
configuration-validation engine of [ADR 0007 rev 2](0007-config-validation-allocation.md) and the generated
boundary types of [ADR 0008 rev 5](0008-boundary-contract-openapi-codegen.md) both live here. Vite is an
...
- **The frontend owns configuration validation** ([ADR 0007 rev 2](0007-config-validation-allocation.md)) and
  consumes generated boundary types ([ADR 0008 rev 5](0008-boundary-contract-openapi-codegen.md)), so the
