...
[ADR 0016 rev 8](0016-maintained-tools-for-standard-artifacts.md) settled which authored checks survive at all)
**Rev:** 8
...
point, since [ADR 0016 rev 8](0016-maintained-tools-for-standard-artifacts.md) adopts four such tools.
...
[ADR 0016 rev 8](0016-maintained-tools-for-standard-artifacts.md) retires those for `pre-commit`, which is
...
[ADR 0016 rev 8](0016-maintained-tools-for-standard-artifacts.md) disposes of in the same languages —
...
- **Enumerate every permitted format instead of deriving them.** Rejected: an enumeration would need
  ...
  [ADR 0016 rev 8](0016-maintained-tools-for-standard-artifacts.md) adopts four tools that bring TOML and a
...
- **Gate the set with a check.** Machine-decidable, and [ADR 0011 rev 2](0011-requirement-or-convention.md)
  ...
  [ADR 0016 rev 8](0016-maintained-tools-for-standard-artifacts.md) had just ruled that one residual obligation
...
- **`check-branch` loses `curl` and `jq` for `urllib` and `json`.** [ADR 0006 rev 5](0006-process-gates.md)'s
  *plain sh + curl + jq — no toolchain* property, already corrected by
  [ADR 0016 rev 8](0016-maintained-tools-for-standard-artifacts.md) when `commitlint` and `pre-commit` were
...
- **The review checklist gains a question, *Languages***, appended to its *Code* section rather than
  ...
  [ADR 0016 rev 8](0016-maintained-tools-for-standard-artifacts.md), which cite one by number with
