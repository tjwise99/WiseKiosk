...
([ADR 0003 rev 5](0003-architecture-as-code-likec4.md)) and Vite
...
([ADR 0003 rev 5](0003-architecture-as-code-likec4.md)) and Vite are invoked; so is whatever an adopted hook
...
- **The review checklist gains a question, *Languages***, appended to its *Code* section rather than
  ...
  [ADR 0003 rev 5](0003-architecture-as-code-likec4.md) and
