...
[ADR 0005 rev 3](0005-traceability-gating.md) rejected requirement→source design-allocation refs and
...
([ADR 0005 rev 3](0005-traceability-gating.md)), so a retired item stays `accepted` and the second word
...
ADR 0005 rev 3's routed duty discharged by nobody: that record rejected design-allocation refs partly
...
[ADR 0005 rev 3](0005-traceability-gating.md) reserves acceptance to a human, and no property of an
