...
system never exchanges anything with is absent rather than external. A tool that acted on the running
deployment would gain an element. What ships beside the image is
