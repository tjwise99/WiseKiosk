...
product behaviour outside the traceability claim [ADR 0005 rev 4](0005-traceability-gating.md) makes over
...
decomposition. That is the work, recorded where work is recorded — [ADR 0005 rev 4](0005-traceability-gating.md)
...
regions — `SYS002`'s<!-- The display's rendering keeps nothing from a viewer --> obligation is on what the
rendering does to the content it is given, and a page given none keeps none from anybody. That is
scope rather than omission, and the shape
