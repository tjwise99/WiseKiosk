...
regions — `SYS002`'s<!-- Each module renders in full, and reads --> *"none of its content hidden"* is
a layout property an empty region of the right size passes. That is scope rather than omission, and the shape
