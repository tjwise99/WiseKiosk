...
[ADR 0005 rev 4](0005-traceability-gating.md) gave every item a `verification-method` and routed the gates
...
The stored-attribute set is [ADR 0005 rev 4](0005-traceability-gating.md)'s, and this record is what
