...
[ADR 0019 rev 8](0019-boundary-at-what-deploys-and-tag-tier.md))
**Rev:** 2
...
this decision waited on one. [ADR 0019 rev 8](0019-boundary-at-what-deploys-and-tag-tier.md) decided
...
[ADR 0008 rev 4](0008-boundary-contract-openapi-codegen.md)'s and which ADR 0019 rev 8 reasons from
rather than decides.
...
- **The model's `link` properties gain their targets with the source they point at.** This record
  ...
  one. How ADR 0019 rev 8 words its own deferral is that record's to change, so this one does not
