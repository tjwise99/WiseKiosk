...
[ADR 0016 rev 10](0016-maintained-tools-for-standard-artifacts.md)
...
- **This is a process/scheduling control, explicitly not a traceability channel.** Requirements
  trace stays diff-derived per [ADR 0005 rev 2](0005-traceability-gating.md); the branch↔issue link
...
- **A gate path with no toolchain** — *plain sh + curl + jq — no toolchain*, the property this record
  ...
  [ADR 0016 rev 10](0016-maintained-tools-for-standard-artifacts.md): the Conventional-Commit
  ...
  [ADR 0017 rev 8](0017-authored-language-set.md) ends what remains of it, moving the authored gates
  to Python.
