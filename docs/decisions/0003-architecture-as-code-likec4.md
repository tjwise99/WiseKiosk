...
level, which [ADR 0019 rev 6](0019-boundary-at-what-deploys-and-tag-tier.md) builds — superseding this
...
- **Traceability hook is reserved, not bound.** Element tags are the mechanism for carrying Doorstop
  ...
  [ADR 0019 rev 6](0019-boundary-at-what-deploys-and-tag-tier.md)'s.
