...
An interactive, browsable rendering of [`boundary/openapi.yaml`](https://github.com/tjwise99/WiseKiosk/blob/main/boundary/openapi.yaml)
...
Swagger UI is fetched at build time as a devDependency and copied into this site; its source is
never committed.
