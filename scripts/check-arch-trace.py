...
the obligation that every accepted item binds are all ADR 0019 rev 6.
...
projection of the model rather than a subject in it, and ADR 0019 rev 6 binds an item to an element
...
def main():
    ...
    for prefix, item in tiered:
        ...
        if prefix not in OBLIGING_TIERS:
            unjudged.append(
                f"{uid}: tier {prefix} is neither obliging nor verification, and ADR 0019 rev 6 "
