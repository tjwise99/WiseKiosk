...
That attribute is also required on its own, on every item, per ADR 0009 rev 1: below `test`, what blocks a
...
def main():
    ...
    if unjustified:
        ...
        print(
            "\nEvery item states what its verification settles and what it does not (ADR 0009 rev 1):"
