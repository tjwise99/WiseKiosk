 ...
 * via its own cast; this file is compiled by `just check-typecheck-frontend` against a client
 * regenerated at build time, which is what makes the pinning a check rather than a claim.
 */
