...
[group('checks')]
[doc('Requirements tree validates: refs resolve, no suspect/unreviewed/orphan items, no inactive item drifted from its stamp, methods consistent, no identifier cited in an item statement')]
check-reqs:
