...
([ADR 0017 rev 6](docs/decisions/0017-authored-language-set.md)) and renumbers everything below.
...
12. **Languages.** Four things `check-languages` states it cannot reach
    ([ADR 0017 rev 6](docs/decisions/0017-authored-language-set.md)), each one yours. Does the change
